...
export const getFinalizeCoursePaymentUrl = (courseId: string, token: string) =>
  `${BASE_URL}/api/private/buycourse/${courseId}/finalice?token=${token}`;
...
export const getSendContactEventUrl = (ongId: string, eventId: string) =>
  `${BASE_URL}/api/private/ongs/${ongId}/events/${eventId}/contact`;
...
export const getFinalizeEventPaymentUrl = (eventId: string, token: string) =>
  `${BASE_URL}/api/private/buyticket/${eventId}/finalice?token=${token}`;
export const getStartProductPaymentUrl = () => `${BASE_URL}/api/private/orders/start`;
export const getFinalizeProductPaymentUrl = (token: string) => `${BASE_URL}/api/private/orders/finalice?token=${token}`;
...
export const getFinalizeBecomeAPartnerUrl = (token: string) =>
  `${BASE_URL}/api/private/subscriptions/finalice?token=${token}`;
